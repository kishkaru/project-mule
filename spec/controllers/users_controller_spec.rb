...
describe UsersController do
    ...
    let(:valid_attributes) { { :first_name => " Jimmy", :last_name => "Fallon", "email" => "test@luckybolt.com", "password" => "testpassword", :phone_number_attributes => {:country => "1", :area => "333", :number => "123-4567"} } }
    let(:valid_create_update_attributes) { { :first_name => " Jimmy", :last_name => "Fallon", "email" => "test@luckybolt.com", "password" => "testpassword", :phone_number => "+1 (123) 456-7890" } }
    ...
    describe "POST create" do
        ...
        describe "with invalid params" do
            it "assigns a newly created but unsaved user as @user" do
                ...
                post :create, {:user => { "role" => "invalid value" }}, valid_session
                assigns(:user).should be_a_new(User)
            end
